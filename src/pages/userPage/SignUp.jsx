                ...
                <div>
                    <Flx>
                        ...
                        <Input
                            ...
                            id='nickname'
                            placeholder='3~10글자 사이 문자'
                            onChange={onChangeInputHandler}
                            required
                        />
                        {
                            // /^[a-zA-Z가-힣0-9]{3,10}$/.test(input.nickname) ? null :
                               // <p className='alertText'>3~10글자 사이 문자를 사용하세요.</p>
                        }
                    </Flx>
                    ...
                    <Flx>
                        ...
                        <StyledInput
                            ...
                            value={input.userId}
                            id='userId'
                            placeholder='3~10글자 사이 영문 소문자,숫자'
                            onChange={onChangeInputHandler}
                            required
                        />
                        <CommonButton size='small' onClick={(e) => onIdChkHandler(e)}>중복확인</CommonButton>
                        {
                            /^[a-z0-9]{3,10}$/.test(input.userId) ? null :
                                <p className='alertText'>3~10글자 사이 영문 소문자,숫자를 사용하세요.</p>
                        }
                    </Flx>
                    ...
                    <Flx>
                        ...
                        <Input
                            ...
                            id='password'
                            placeholder='3~10글자 사이 영문,숫자,특수문자'
                            onChange={onChangeInputHandler}
                            required
                        />
                        {
                            /^[a-zA-Z0-9!@#$%^&*()\-_=+{};:,.<>?[\]\\/]{3,10}$/.test(input.password) ? null :
                                <p className='alertText'>3~10글자 사이 영문,숫자,특수문자를 사용하세요.</p>
                        }
                    </Flx>
